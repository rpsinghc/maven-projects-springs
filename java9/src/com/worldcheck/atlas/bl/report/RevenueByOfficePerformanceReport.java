...
public class RevenueByOfficePerformanceReport implements IAtlasReport {
	private static final String YEAR = "year";
	private ILogProducer logger = LogProducerImpl
			.getLogger("com.worldcheck.atlas.bl.report.RevenueByOfficePerformanceReport");
	...
	public List fetchReport(HttpServletRequest request, HttpServletResponse response) throws CMSException {
		...
		List list = this.chartReportDAO.fetchRevenueByOfficePerformanceReport(request.getParameter("year"));
