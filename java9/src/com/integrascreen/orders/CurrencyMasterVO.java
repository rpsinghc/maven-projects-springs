...
public class CurrencyMasterVO implements Serializable {
	private String code;
	private String description;
	private String status;
	private Object __equalsCalc = null;
	private boolean __hashCodeCalc = false;
	private static TypeDesc typeDesc = new TypeDesc(CurrencyMasterVO.class, true);

	static {
		typeDesc.setXmlType(new QName("http://orders.integrascreen.com", "CurrencyMasterVO"));
	...
	public CurrencyMasterVO() {
	}

	public CurrencyMasterVO(String code, String description, String status) {
		this.code = code;
	...
	public synchronized boolean equals(Object obj) {
		if (!(obj instanceof CurrencyMasterVO)) {
			return false;
		} else {
			CurrencyMasterVO other = (CurrencyMasterVO) obj;
			if (obj == null) {
				return false;
			} else if (this == obj) {
				return true;
