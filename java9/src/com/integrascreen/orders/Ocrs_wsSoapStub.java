...
public class Ocrs_wsSoapStub extends Stub implements Ocrs_wsSoap {
	...
	public Ocrs_wsSoapStub() throws AxisFault {
		this((Service) null);
	}

	public Ocrs_wsSoapStub(URL endpointURL, Service service) throws AxisFault {
		this(service);
		super.cachedEndpoint = endpointURL;
	}

	public Ocrs_wsSoapStub(Service service) throws AxisFault {
